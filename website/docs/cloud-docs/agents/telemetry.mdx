...
![telemetry architecture diagram](/website/public/img/telemetry-arch-light.png#light-theme-only)

-->

![telemetry architecture diagram](/website/public/img/telemetry-arch-dark.png)

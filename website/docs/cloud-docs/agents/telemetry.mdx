---
page_title: Telemetry for HCP Terraform agents and Terraform Enterprise agents
description: >-
  Use telemetry data to understand the performance and behavior of your HCP Terraform Agents. Learn how to configure telemetry, configure and run the OpenTelemetry collector, and more.
---

---
page_title: Request forwarding for HCP Terraform agents and Terraform Enterprise agents
description: >-
  Learn how HCP Terraform agents can access private network resources using request forwarding.
---

...
![Request forwarding architecture diagram](/website/public/img/request-forwarding-arch-light.png#light-theme-only)

-->

![Request forwarding architecture diagram](/website/public/img/request-forwarding-arch-dark.png)

...
|---------------|-----------------------------------------------------------------------------------------------------------------|--------------------------|
| apply         | [Terraform Apply](https://developer.hashicorp.com/terraform/cli/commands/apply)                                 | `terraform apply`        |
| assessment    | [HCP Terraform Health Assessments](https://developer.hashicorp.com/terraform/cloud-docs/workspaces/health)      | -                        |
| ingress       | [Configuration Version Ingress](https://developer.hashicorp.com/terraform/cloud-docs/workspaces/configurations) | -                        |
| plan          | [Terraform Plan](https://developer.hashicorp.com/terraform/cli/commands/plan)                                   | `terraform plan`         |
| policy        | [HCP Terraform policy assesment](https://developer.hashicorp.com/terraform/cloud-docs/policy-enforcement)       | -                        |
| test          | [HCP Terraform Registry Module Tests](https://developer.hashicorp.com/terraform/cloud-docs/registry/test)       | `terraform test`         |

...
The number of concurrent runs your organization is entitled to use determines the number of active agents you can deploy. Agents are available in the [Terraform Cloud Business Tier](https://www.hashicorp.com/products/terraform/pricing).

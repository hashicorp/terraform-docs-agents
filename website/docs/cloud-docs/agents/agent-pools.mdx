...
- You must be a member of the **Owners** team or a team with [Manage Agent Pools permission](/terraform/cloud-docs/users-teams-organizations/permissions#manage-agent-pools) to manage an organization's agents.

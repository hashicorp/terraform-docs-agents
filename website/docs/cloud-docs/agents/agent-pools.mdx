...
|---------------|-------------------------------|-----------------------------------------------------------------------------------------------------------------|--------------------------|
| apply         | Apply workspace runs          | [Terraform Apply](https://developer.hashicorp.com/terraform/cli/commands/apply)                                 | `terraform apply`                                                                                              |
| assessment    | Health Assessments            | [HCP Terraform Health Assessments](https://developer.hashicorp.com/terraform/cloud-docs/workspaces/health)      | -                                                                               |
| ingress       | Configuration Version Ingress | [Configuration Version Ingress](https://developer.hashicorp.com/terraform/cloud-docs/workspaces/configurations) | -                                                                                                          |
| plan          | Plan workspace runs           | [Terraform Plan](https://developer.hashicorp.com/terraform/cli/commands/plan)                                   | `terraform plan`                                                                                                |
| policy        | Policy compliance checks      | [HCP Terraform policy assesment](https://developer.hashicorp.com/terraform/cloud-docs/policy-enforcement)       | -                                                                                                               |
| test          | Module tests                  | [HCP Terraform Registry Module Tests](https://developer.hashicorp.com/terraform/cloud-docs/registry/test)       | `terraform test`                                                                                                |

---
<<<<<<< Updated upstream
page_title: Agent changelog for HCP Terraform and Terraform Enterprise
description: >-
  Use this log of HCP Terraform agent changes to track new features and evolving functionality over time.
=======
...
* Ensure ephemeral variables (Terraform v1.10 feature) are passed between plan & apply (#831)

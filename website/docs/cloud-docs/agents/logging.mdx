---
<<<<<<< Updated upstream
page_title: Logging for HCP Terraform agents and Terraform Enterprise agents
description: >-
  HCP Terraform agents log messages that tell operators about agent behavior. Learn how to monitor agent log outputs and flash messages to keep up to date on important changes.
=======

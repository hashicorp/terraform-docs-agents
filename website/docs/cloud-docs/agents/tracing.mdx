---
page_title: Tracing for HCP Terraform agents and Terraform Enterprise agents
description: >-
  Use tracing spans to understand and debug the operations your HCP Terraform agents perform. Learn about supported tools and rules for tracing spans.
---
